...
public class WrapperAppiumDriver {
    ...
    public static AppiumDriver buildAppiumDriver() {
        ...
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Pixel_API26");
        capabilities.setCapability(MobileCapabilityType.NO_RESET, false);
        capabilities.setCapability(MobileCapabilityType.APP, "/Users/deepaksharma/Documents/Study/Technosoft/ionic-conference-emulator.apk");
        ...
        capabilities.setCapability("avd","Pixel_API26");
