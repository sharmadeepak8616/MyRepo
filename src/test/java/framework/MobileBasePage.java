...
public class MobileBasePage {
    ...
    protected void initPageElements() {
        PageFactory.initElements(new AppiumFieldDecorator(WrapperAppiumDriver.getAppiumDriver(), 15, TimeUnit.SECONDS), this);
    }
    ...
    protected String getAttributeOfAnElement(MobileElement mobileElement, String attribute) {
